...
import '../src/extensions/autovalidatemode_extension.dart';

/// A container for form fields.
class OFormBuilder extends StatefulWidget {
  ...
  /// from disposed [OFormBuilderField]s. This is useful for dynamic forms where
  ...
  static OFormBuilderState? of(BuildContext context) =>
      context.findAncestorStateOfType<OFormBuilderState>();

  @override
  OFormBuilderState createState() => OFormBuilderState();
}

/// A type alias for a map of form fields.
typedef FormBuilderFields =
    Map<String, FormBuilderFieldState<OFormBuilderField<dynamic>, dynamic>>;

class OFormBuilderState extends State<OFormBuilder> {
...
class _FormBuilderScope extends InheritedWidget {
  const _FormBuilderScope({
    ...
    required OFormBuilderState formState,
  }) : _formState = formState;

  final OFormBuilderState _formState;

  /// The [Form] associated with this widget.
  OFormBuilder get form => _formState.widget;
