...
class OFormBuilderField<T> extends FormField<T> {
  ...
  @override
  FormBuilderFieldState<OFormBuilderField<T>, T> createState() =>
      FormBuilderFieldState<OFormBuilderField<T>, T>();
}

class FormBuilderFieldState<F extends OFormBuilderField<T>, T>
    extends FormFieldState<T> {
  String? _customErrorText;
  OFormBuilderState? _formBuilderState;
  bool _touched = false;
  bool _dirty = false;
  ...
  /// Returns the parent [OFormBuilderState] if it exists.
  OFormBuilderState? get formState => _formBuilderState;

  /// Returns the initial value, which may be declared at the field, or by the
  /// parent [OFormBuilder.initialValue]. When declared at both levels, the field
  ...
  ///
  /// See [OFormBuilder.skipDisabled] for more information.
  ...
  void initState() {
    ...
    _formBuilderState = OFormBuilder.of(context);
  ...
  @override
  void didUpdateWidget(covariant OFormBuilderField<T> oldWidget) {
  ...
  bool validate({
    ...
    final fields =
        ...
        <String, FormBuilderFieldState<OFormBuilderField<dynamic>, dynamic>>{};
