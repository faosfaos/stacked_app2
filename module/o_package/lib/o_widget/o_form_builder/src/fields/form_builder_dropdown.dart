...
class OFormBuilderDropdown<T> extends OFormBuilderFieldDecoration<T> {
  ...
  @override
  FormBuilderFieldDecorationState<OFormBuilderDropdown<T>, T> createState() =>
      _FormBuilderDropdownState<T>();
}

class _FormBuilderDropdownState<T>
    extends FormBuilderFieldDecorationState<OFormBuilderDropdown<T>, T> {
  @override
  void didUpdateWidget(covariant OFormBuilderDropdown<T> oldWidget) {
