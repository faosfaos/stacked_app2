...
import '../options/form_builder_chip_option.dart';

/// A list of `Chip`s that acts like radio buttons
class OFormBuilderChoiceChips<T> extends OFormBuilderFieldDecoration<T> {
  /// The list of items the user can select.
  final List<OFormBuilderChipOption<T>> options;
           ...
           return Focus(
             ...
             child: InputDecorator(
               ...
               child: Wrap(
                 ...
                 children: <Widget>[
                   for (OFormBuilderChipOption<T> option in options)
                     ChoiceChip(
                       label: option,
                       side: side,
                       shape: shape,
  ...
  @override
  FormBuilderFieldDecorationState<OFormBuilderChoiceChips<T>, T>
  createState() => _FormBuilderChoiceChipState<T>();
}

class _FormBuilderChoiceChipState<T>
    extends FormBuilderFieldDecorationState<OFormBuilderChoiceChips<T>, T> {
