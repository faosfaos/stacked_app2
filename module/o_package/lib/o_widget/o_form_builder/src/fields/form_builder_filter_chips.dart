...
class OFormBuilderFilterChips<T> extends OFormBuilderFieldDecoration<List<T>> {
  ...
  @override
  FormBuilderFieldDecorationState<OFormBuilderFilterChips<T>, List<T>>
