...
class OFormBuilderCheckboxGroup<T>
    extends OFormBuilderFieldDecoration<List<T>> {
  ...
  @override
  FormBuilderFieldDecorationState<OFormBuilderCheckboxGroup<T>, List<T>>
