...
class OFormBuilderDateRangePicker
    extends OFormBuilderFieldDecoration<DateTimeRange> {
  ...
  @override
  FormBuilderFieldDecorationState<OFormBuilderDateRangePicker, DateTimeRange>
...
class _FormBuilderDateRangePickerState
  ...
  String format(DateTime date) => OFormBuilderDateRangePicker.tryFormat(
    date,
