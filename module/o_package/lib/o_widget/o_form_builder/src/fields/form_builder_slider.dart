...
import '../options/display_values_enum.dart';

/// Field for selection of a numerical value on a slider
class OFormBuilderSlider extends OFormBuilderFieldDecoration<double> {
  ...
  final ODisplayValues displayValues;
  ...
  OFormBuilderSlider({
    ...
    this.numberFormat,
    this.displayValues = ODisplayValues.all,
             ...
             child: Container(
               ...
               child: Column(
                 ...
                 children: [
                   ...
                   Row(
                     children: <Widget>[
                       if (displayValues != ODisplayValues.none &&
                           displayValues != ODisplayValues.current)
                         minValueWidget?.call(
                       ...
                       const Spacer(),
                       if (displayValues != ODisplayValues.none &&
                           displayValues != ODisplayValues.minMax)
                         valueWidget?.call(
  ...
  @override
  FormBuilderFieldDecorationState<OFormBuilderSlider, double> createState() =>
      _FormBuilderSliderState();
}

class _FormBuilderSliderState
    extends FormBuilderFieldDecorationState<OFormBuilderSlider, double> {}
