...
mixin MixinOFormBuilder {
  InputDecoration? textIntpuDecoration() {
...
class OFormBuilderTextField extends OFormBuilderFieldDecoration<String>
    with MixinOFormBuilder {
  ...
  @override
  FormBuilderFieldDecorationState<OFormBuilderTextField, String>
  createState() => _FormBuilderTextFieldState();
}

class _FormBuilderTextFieldState
    extends FormBuilderFieldDecorationState<OFormBuilderTextField, String> {
