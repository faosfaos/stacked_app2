...
import '../widgets/grouped_radio.dart';

/// Field to select one value from a list of Radio Widgets
class OFormBuilderRadioGroup<T> extends OFormBuilderFieldDecoration<T> {
  ...
  final List<OFormBuilderFieldOption<T>> options;
  ...
  @override
  FormBuilderFieldDecorationState<OFormBuilderRadioGroup<T>, T> createState() =>
      _FormBuilderRadioGroupState<T>();
}

class _FormBuilderRadioGroupState<T>
    extends FormBuilderFieldDecorationState<OFormBuilderRadioGroup<T>, T> {}
